...
Enforces the **Understand → Plan → Write Tests → Write Code → Verify → Document** workflow and guides AI coding agents to:
...
| Section | Key Rules |
|---|---|
| **Method** | Understand → Plan → Write Tests → Write Code → Verify → Document (6 steps) |
